...
# ---------------------------------------------------------------------------
# modules.open_chrome must be import-safe: it should not open a browser just by
# being imported. Browser creation belongs in runAiBot.main().
# ---------------------------------------------------------------------------
_chrome_kwargs = []
...
def test_import_time_launch_is_import_safe():
    '''Importing the module must stay silent and never create a browser session.'''
    assert not _chrome_kwargs, "modules.open_chrome should not create a browser on import"
