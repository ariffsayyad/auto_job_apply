...
# Your legal name
first_name = "Ariff"  # Your first name in quotes Eg: "First", "Sai"
middle_name = "   "  # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "Sayyad"  # Your last name in quotes Eg: "Last", "Golla"

# Phone number (required), make sure it's valid.
phone_number = (
    "Enter Your Mobile Number "  # Enter your 10 digit number in quotes Eg: "9876543210"
)
...
street = "Enter Your Street Address"  # "123 Main St", "456 Elm St", etc.
state = "Enter Your State"
zipcode = "Enter Your Pin Code"
country = "Enter Your Country"  # "United States", "Canada", etc.
...
gender = "Select Your Gender"  # "Male", "Female", "Other", "Decline" or ""
